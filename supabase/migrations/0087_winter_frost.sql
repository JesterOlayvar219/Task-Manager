/*
  # Fix task_details view username joins
...
SELECT 
  ...
  COALESCE(c."displayName", c.username, t.created_by) as creator_username,
  COALESCE(a."displayName", a.username, t.assignee) as assignee_username
FROM tasks t
