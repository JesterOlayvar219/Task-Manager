...
ALTER TABLE public.users
  DROP CONSTRAINT IF EXISTS users_username_key CASCADE,
...
ALTER TABLE public.users
  ...
  DROP CONSTRAINT IF EXISTS users_displayname_check,
  ADD CONSTRAINT users_displayname_check CHECK (char_length("displayName") >= 1),
