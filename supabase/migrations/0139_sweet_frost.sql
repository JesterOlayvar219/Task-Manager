...
CREATE INDEX IF NOT EXISTS idx_private_chat_messages_unread 
  ON private_chat_messages(private_chat_id, sender) 
  WHERE NOT is_read;
...
CREATE POLICY "private_chat_messages_select_v2"
...
CREATE POLICY "private_chat_messages_insert_v2"
...
CREATE POLICY "private_chat_messages_update_v2"
